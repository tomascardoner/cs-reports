...
#pragma warning restore CA2213 // Disposable fields should be disposed
    ...
    {
        _panelReport?.Dispose();
        _panelDatasource?.Dispose();
        _panelDatasourceParameters?.Dispose();
        _panelDatasourceParameter?.Dispose();
        _panelDatasourceFields?.Dispose();
        _panelDatasourceField?.Dispose();
        _panelFonts?.Dispose();
        _panelFont?.Dispose();
        _panelBrushes?.Dispose();
        _panelBrush?.Dispose();
        _panelSections?.Dispose();
        _panelSection?.Dispose();
        _panelLines?.Dispose();
        _panelLine?.Dispose();
        _panelRectangles?.Dispose();
        _panelRectangle?.Dispose();
        _panelTexts?.Dispose();
        _panelText?.Dispose();
    ...
    {
        return string.IsNullOrEmpty(FilePath) ? SaveReportAs() : Storage.FileSystem.Save(_report, FilePath);
    }
    ...
    private void TreeViewReport_AfterSelect(object sender, TreeViewEventArgs e)
    {
        ...
        switch (nodeInfo.Item1)
        {
            ...
            case DatasourceParameterKey:
                DatasourceParameterPanelShow(short.Parse(nodeInfo.Item2, CultureInfo.InvariantCulture));
                break;
            case DatasourceFieldsKey:
                DatasourceFieldsPanelShow();
                break;
            case DatasourceFieldKey:
                DatasourceFieldPanelShow(short.Parse(nodeInfo.Item2, CultureInfo.InvariantCulture));
                break;
            case FontsKey:
                FontsPanelShow();
                break;
            case FontKey:
                FontPanelShow(short.Parse(nodeInfo.Item2, CultureInfo.InvariantCulture));
                break;
            case BrushesKey:
                BrushesPanelShow();
                break;
            case BrushKey:
                BrushPanelShow(short.Parse(nodeInfo.Item2, CultureInfo.InvariantCulture));
                break;
            case SectionsKey:
                SectionsPanelShow();
                break;
            case SectionKey:
                SectionPanelShow(short.Parse(nodeInfo.Item2, CultureInfo.InvariantCulture));
                break;
            case LinesKey:
                LinesPanelShow(GetShortIdFromParentNode(e.Node));
                break;
            case LineKey:
                LinePanelShow(short.Parse(nodeInfo.Item2, CultureInfo.InvariantCulture));
                break;
            case RectanglesKey:
                RectanglesPanelShow(GetShortIdFromParentNode(e.Node));
                break;
            case RectangleKey:
                RectanglePanelShow(short.Parse(nodeInfo.Item2, CultureInfo.InvariantCulture));
                break;
            case TextsKey:
                TextsPanelShow(GetShortIdFromParentNode(e.Node));
                break;
            case TextKey:
                TextPanelShow(short.Parse(nodeInfo.Item2, CultureInfo.InvariantCulture));
                break;
            default:
                break;
        }
    ...
    private static Tuple<string, string> GetTreeNodeInfoFromTag(TreeNode treeNode)
    {
        ...
        string nodeType = nodeTag[..nodeTag.IndexOf('@', StringComparison.Ordinal)];
    ...
    private static short GetShortIdFromParentNode(TreeNode treeNode)
    {
        ...
        return short.Parse(nodeInfo.Item2, CultureInfo.InvariantCulture);
    }
    ...
    {
        return _report.Datasource is null ? Properties.Resources.StringDatasource : _report.Datasource.DisplayName;
    }
    ...
    {
        return Properties.Resources.StringDatasourceParameters + string.Format(CultureInfo.InvariantCulture, Properties.Resources.StringTreeNodeItemsCount, _report.Datasource?.Parameters.Count);
    }
    ...
    {
        TreeNode treeTreeNodeDatasourceParameter = AddTreeNode(DatasourceParameterTreeNodeGetText(parameter), DatasourceParameterKey, parameter.ParameterId.ToString(CultureInfo.InvariantCulture));
    ...
    private void DatasourceParameterUpdated(object sender, Panels.EventHandlers.DatasourceParameterEventArgs e)
    {
        Model.DatasourceParameter? parameter = _report.Datasource?.Parameters.FirstOrDefault(p => p.ParameterId == e.ParameterId);
        if (parameter is null)
        {
            return;
        }
        ...
        TreeNode? treeTreeNodeDatasourceParameter = GetTreeNodeByTag(treeTreeNodeDatasourceParameters, DatasourceParameterKey, e.ParameterId.ToString(CultureInfo.InvariantCulture));
    ...
    private void DatasourceParameterDeleted(object sender, Panels.EventHandlers.DatasourceParameterEventArgs e)
    {
        TreeNode treeTreeNodeDatasourceParameters = treeViewReport.Nodes[TreeNodeReportIndex].Nodes[TreeNodeDatasourceIndex].Nodes[TreeNodeDatasourceParametersIndex];
        TreeNode? treeTreeNodeDatasourceParameter = GetTreeNodeByTag(treeTreeNodeDatasourceParameters, DatasourceParameterKey, e.ParameterId.ToString(CultureInfo.InvariantCulture));
    ...
    {
        return Properties.Resources.StringDatasourceFields + string.Format(CultureInfo.InvariantCulture, Properties.Resources.StringTreeNodeItemsCount, _report.Datasource?.Fields.Count);
    }
    ...
    {
        TreeNode treeTreeNodeDatasourceField = AddTreeNode(DatasourceFieldTreeNodeGetText(field), DatasourceFieldKey, field.FieldId.ToString(CultureInfo.InvariantCulture));
    ...
    private void DatasourceFieldUpdated(object sender, Panels.EventHandlers.DatasourceFieldEventArgs e)
    {
        Model.DatasourceField? field = _report.Datasource?.Fields.FirstOrDefault(f => f.FieldId == e.FieldId);
        if (field is null)
        {
            return;
        }
        ...
        TreeNode? treeTreeNodeDatasourceField = GetTreeNodeByTag(treeTreeNodeDatasourceFields, DatasourceFieldKey, e.FieldId.ToString(CultureInfo.InvariantCulture));
    ...
    private void DatasourceFieldDeleted(object sender, Panels.EventHandlers.DatasourceFieldEventArgs e)
    {
        TreeNode treeTreeNodeDatasourceFields = treeViewReport.Nodes[TreeNodeReportIndex].Nodes[TreeNodeDatasourceIndex].Nodes[TreeNodeDatasourceFieldsIndex];
        TreeNode? treeTreeNodeDatasourceField = GetTreeNodeByTag(treeTreeNodeDatasourceFields, DatasourceFieldKey, e.FieldId.ToString(CultureInfo.InvariantCulture));
    ...
    {
        return Properties.Resources.StringFonts + string.Format(CultureInfo.InvariantCulture, Properties.Resources.StringTreeNodeItemsCount, _report.Fonts.Count);
    }
    ...
    {
        TreeNode treeTreeNodeFont = AddTreeNode(FontTreeNodeGetText(font), FontKey, font.FontId.ToString(CultureInfo.InvariantCulture));
    ...
    private void FontUpdated(object sender, Panels.EventHandlers.FontEventArgs e)
    {
        Model.Font? font = _report.Fonts.FirstOrDefault(f => f.FontId == e.FontId);
        if (font is null)
        {
            return;
        }
        ...
        TreeNode? treeTreeNodeFont = GetTreeNodeByTag(treeTreeNodeFonts, FontKey, font.FontId.ToString(CultureInfo.InvariantCulture));
    ...
    private void FontDeleted(object sender, Panels.EventHandlers.FontEventArgs e)
    {
        TreeNode treeTreeNodeFonts = treeViewReport.Nodes[TreeNodeReportIndex].Nodes[TreeNodeFontsIndex];
        TreeNode? treeTreeNodeFont = GetTreeNodeByTag(treeTreeNodeFonts, FontKey, e.FontId.ToString(CultureInfo.InvariantCulture));
    ...
    {
        return Properties.Resources.StringBrushes + string.Format(CultureInfo.InvariantCulture, Properties.Resources.StringTreeNodeItemsCount, _report.Brushes.Count);
    }
    ...
    {
        TreeNode treeTreeNodeBrush = AddTreeNode(BrushTreeNodeGetText(brush), BrushKey, brush.BrushId.ToString(CultureInfo.InvariantCulture));
    ...
    private void BrushUpdated(object sender, Panels.EventHandlers.BrushEventArgs e)
    {
        Model.Brush? brush = _report.Brushes.FirstOrDefault(f => f.BrushId == e.BrushId);
        if (brush is null)
        {
            return;
        }
        ...
        TreeNode? treeTreeNodeBrush = GetTreeNodeByTag(treeTreeNodeBrushs, BrushKey, brush.BrushId.ToString(CultureInfo.InvariantCulture));
    ...
    private void BrushDeleted(object sender, Panels.EventHandlers.BrushEventArgs e)
    {
        TreeNode treeTreeNodeBrushs = treeViewReport.Nodes[TreeNodeReportIndex].Nodes[TreeNodeBrushesIndex];
        TreeNode? treeTreeNodeBrush = GetTreeNodeByTag(treeTreeNodeBrushs, BrushKey, e.BrushId.ToString(CultureInfo.InvariantCulture));
    ...
    {
        return Properties.Resources.StringSections + string.Format(CultureInfo.InvariantCulture, Properties.Resources.StringTreeNodeItemsCount, _report.Sections.Count);
    }
    ...
    {
        TreeNode treeTreeNodeSection = AddTreeNode(SectionTreeNodeGetText(section), SectionKey, section.SectionId.ToString(CultureInfo.InvariantCulture));
    ...
    private void SectionUpdated(object sender, Panels.EventHandlers.SectionEventArgs e)
    {
        Model.Section? section = _report.Sections.FirstOrDefault(s => s.SectionId == e.SectionId);
        if (section is null)
        {
            return;
        }
        ...
        TreeNode? treeTreeNodeSection = GetTreeNodeByTag(treeTreeNodeSections, SectionKey, section.SectionId.ToString(CultureInfo.InvariantCulture));
    ...
    private void SectionDeleted(object sender, Panels.EventHandlers.SectionEventArgs e)
    {
        TreeNode treeTreeNodeSections = treeViewReport.Nodes[TreeNodeReportIndex].Nodes[TreeNodeSectionsIndex];
        TreeNode? treeTreeNodeSection = GetTreeNodeByTag(treeTreeNodeSections, SectionKey, e.SectionId.ToString(CultureInfo.InvariantCulture));
    ...
    {
        return Properties.Resources.StringLines + string.Format(CultureInfo.InvariantCulture, Properties.Resources.StringTreeNodeItemsCount, count);
    }
    ...
    {
        TreeNode treeTreeNodeLine = AddTreeNode(LineTreeNodeGetText(line), LineKey, line.LineId.ToString(CultureInfo.InvariantCulture));
    ...
    private void LineUpdated(object sender, Panels.EventHandlers.LineEventArgs e)
    {
        Model.Line? line = _report.Lines.FirstOrDefault(f => f.LineId == e.LineId);
        if (line is null)
        {
            return;
        }

        TreeNode? treeTreeNodeSection = GetTreeNodeByTag(treeViewReport.Nodes[TreeNodeReportIndex].Nodes[TreeNodeSectionsIndex], SectionKey, e.SectionId1.ToString(CultureInfo.InvariantCulture));
        if (treeTreeNodeSection is null)
        {
            return;
        }
        ...
        TreeNode? treeTreeNodeLine = GetTreeNodeByTag(treeTreeNodeLines, LineKey, line.LineId.ToString(CultureInfo.InvariantCulture));
        if (treeTreeNodeLine is null)
        {
            treeTreeNodeLine = LineCreateTreeNode(line, treeTreeNodeLines);
            treeTreeNodeLines.Text = LinesTreeNodeGetText(_report.Lines.Count(l => l.SectionId1 == e.SectionId1));
        }
        else
        {
    ...
    private void LineDeleted(object sender, Panels.EventHandlers.LineEventArgs e)
    {
        TreeNode? treeTreeNodeSection = GetTreeNodeByTag(treeViewReport.Nodes[TreeNodeReportIndex].Nodes[TreeNodeSectionsIndex], SectionKey, e.SectionId1.ToString(CultureInfo.InvariantCulture));
        if (treeTreeNodeSection is null)
        {
        ...
        TreeNode treeTreeNodeLines = treeTreeNodeSection.Nodes[TreeNodeLinesIndex];
        TreeNode? treeTreeNodeLine = GetTreeNodeByTag(treeTreeNodeLines, LineKey, e.LineId.ToString(CultureInfo.InvariantCulture));
    ...
    {
        return Properties.Resources.StringRectangles + string.Format(CultureInfo.InvariantCulture, Properties.Resources.StringTreeNodeItemsCount, count);
    }
    ...
    {
        TreeNode treeTreeNodeRectangle = AddTreeNode(RectangleTreeNodeGetText(rectangle), RectangleKey, rectangle.RectangleId.ToString(CultureInfo.InvariantCulture));
    ...
    private void RectangleUpdated(object sender, Panels.EventHandlers.RectangleEventArgs e)
    {
        Model.Rectangle? rectangle = _report.Rectangles.FirstOrDefault(r => r.RectangleId == e.RectangleId);
        if (rectangle is null)
        {
            return;
        }
        ...
        TreeNode? treeTreeNodeRectangle = GetTreeNodeByTag(treeTreeNodeRectangles, RectangleKey, rectangle.RectangleId.ToString(CultureInfo.InvariantCulture));
        if (treeTreeNodeRectangle is null)
        {
            treeTreeNodeRectangle = RectangleCreateTreeNode(rectangle, treeTreeNodeRectangles);
            treeTreeNodeRectangles.Text = RectanglesTreeNodeGetText(_report.Rectangles.Count(l => l.SectionId1 == e.SectionId1));
        }
        else
        {
    ...
    private void RectangleDeleted(object sender, Panels.EventHandlers.RectangleEventArgs e)
    {
        TreeNode? treeTreeNodeSection = GetTreeNodeByTag(treeViewReport.Nodes[TreeNodeReportIndex].Nodes[TreeNodeSectionsIndex], SectionKey, e.SectionId1.ToString(CultureInfo.InvariantCulture));
        if (treeTreeNodeSection is null)
        {
        ...
        TreeNode treeTreeNodeRectangles = treeTreeNodeSection.Nodes[TreeNodeRectanglesIndex];
        TreeNode? treeTreeNodeRectangle = GetTreeNodeByTag(treeTreeNodeRectangles, RectangleKey, e.RectangleId.ToString(CultureInfo.InvariantCulture));
        if (treeTreeNodeRectangle is not null)
        {
            treeTreeNodeRectangles.Nodes.Remove(treeTreeNodeRectangle);
            treeTreeNodeRectangles.Text = RectanglesTreeNodeGetText(_report.Rectangles.Count(r => r.SectionId1 == e.SectionId1));
        }
    }
    ...
    {
        return Properties.Resources.StringTexts + string.Format(CultureInfo.InvariantCulture, Properties.Resources.StringTreeNodeItemsCount, count);
    }
    ...
    {
        TreeNode treeTreeNodeText = AddTreeNode(TextTreeNodeGetText(text), TextKey, text.TextId.ToString(CultureInfo.InvariantCulture));
    ...
    private void TextUpdated(object sender, Panels.EventHandlers.TextEventArgs e)
    {
        Model.Text? text = _report.Texts.FirstOrDefault(f => f.TextId == e.TextId);
        if (text is null)
        {
            return;
        }

        TreeNode? treeTreeNodeSection = GetTreeNodeByTag(treeViewReport.Nodes[TreeNodeReportIndex].Nodes[TreeNodeSectionsIndex], SectionKey, e.SectionId.ToString(CultureInfo.InvariantCulture));
        if (treeTreeNodeSection is null)
        {
            return;
        }
        ...
        TreeNode? treeTreeNodeText = GetTreeNodeByTag(treeTreeNodeTexts, TextKey, text.TextId.ToString(CultureInfo.InvariantCulture));
        if (treeTreeNodeText is null)
        {
            treeTreeNodeText = TextCreateTreeNode(text, treeTreeNodeTexts);
            treeTreeNodeTexts.Text = TextsTreeNodeGetText(_report.Texts.Count(t => t.SectionId == e.SectionId));
        }
        else
        {
    ...
    private void TextDeleted(object sender, Panels.EventHandlers.TextEventArgs e)
    {
        TreeNode? treeTreeNodeSection = GetTreeNodeByTag(treeViewReport.Nodes[TreeNodeReportIndex].Nodes[TreeNodeSectionsIndex], SectionKey, e.SectionId.ToString(CultureInfo.InvariantCulture));
        if (treeTreeNodeSection is null)
        {
        ...
        TreeNode treeTreeNodeTexts = treeTreeNodeSection.Nodes[TreeNodeTextsIndex];
        TreeNode? treeTreeNodeText = GetTreeNodeByTag(treeTreeNodeTexts, TextKey, e.TextId.ToString(CultureInfo.InvariantCulture));
