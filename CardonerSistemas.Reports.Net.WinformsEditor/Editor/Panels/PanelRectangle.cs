...
public partial class PanelRectangle : UserControl
{
    ...
    public event EventHandler<EventHandlers.RectangleEventArgs>? RectangleUpdated;
    public event EventHandler<EventHandlers.RectangleEventArgs>? RectangleDeleted;
    ...
    private void ApplyChanges(object sender, EventArgs e)
    {
        ...
        {
            RectangleUpdated(this, new EventHandlers.RectangleEventArgs(_rectangle.RectangleId, _rectangle.SectionId1));
        }
    }
    ...
    {
        if (_rectangle is null || MessageBox.Show(string.Format(CultureInfo.InvariantCulture, Properties.Resources.StringRectangleDeleteConfirmation, _rectangle.DisplayName), _applicationTitle, MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No)
        {
            return;
        }
        ...
        {
            RectangleDeleted(this, new EventHandlers.RectangleEventArgs(_rectangle.RectangleId, _rectangle.SectionId1));
        }
    }
