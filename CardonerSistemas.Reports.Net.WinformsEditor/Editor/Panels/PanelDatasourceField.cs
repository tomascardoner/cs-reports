...
public partial class PanelDatasourceField : UserControl
{
    ...
    public event EventHandler<EventHandlers.DatasourceFieldEventArgs>? FieldUpdated;
    public event EventHandler<EventHandlers.DatasourceFieldEventArgs>? FieldDeleted;
    ...
    private void InitializeForm()
    {
        ...
        buttonDelete.Text = Properties.Resources.StringDatasourceFieldsDelete;
    ...
    private void ApplyChanges(object sender, EventArgs e)
    {
        ...
        {
            FieldUpdated(this, new EventHandlers.DatasourceFieldEventArgs(_datasourceField.FieldId));
        }
    }
    ...
    private void Delete(object sender, EventArgs e)
    {
        ...
        {
            FieldDeleted(this, new EventHandlers.DatasourceFieldEventArgs(_datasourceField.FieldId));
        }
    }
