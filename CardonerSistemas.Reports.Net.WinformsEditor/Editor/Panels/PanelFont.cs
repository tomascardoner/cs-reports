...
public partial class PanelFont : UserControl
{
    ...
    public event EventHandler<EventHandlers.FontEventArgs>? FontUpdated;
    public event EventHandler<EventHandlers.FontEventArgs>? FontDeleted;
    ...
    private void InitializeForm()
    {
        ...
        buttonDelete.Text = Properties.Resources.StringFontsDelete;
    }
    ...
    private void ApplyChanges(object sender, EventArgs e)
    {
        ...
        {
            FontUpdated(this, new EventHandlers.FontEventArgs(_font.FontId));
        }
    }
    ...
    private void Delete(object sender, EventArgs e)
    {
        ...
        {
            FontDeleted(this, new EventHandlers.FontEventArgs(_font.FontId));
        }
    }
