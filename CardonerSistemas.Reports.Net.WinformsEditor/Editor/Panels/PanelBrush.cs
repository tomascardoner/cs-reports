...
public partial class PanelBrush : UserControl
{
    ...
    public event EventHandler<EventHandlers.BrushEventArgs>? BrushUpdated;
    public event EventHandler<EventHandlers.BrushEventArgs>? BrushDeleted;
    ...
    private void ApplyChanges(object sender, EventArgs e)
    {
        ...
        {
            BrushUpdated(this, new EventHandlers.BrushEventArgs(_brush.BrushId));
        }
    }
    ...
    {
        if (_brush is null || MessageBox.Show(string.Format(CultureInfo.InvariantCulture, Properties.Resources.StringBrushDeleteConfirmation, _brush.DisplayName), _applicationTitle, MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No)
        {
            return;
        }
        ...
        {
            BrushDeleted(this, new EventHandlers.BrushEventArgs(_brush.BrushId));
        }
    }
