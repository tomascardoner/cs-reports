...
public partial class PanelDatasourceParameters : UserControl
{
    ...
    public event EventHandler<EventHandlers.DatasourceParameterEventArgs>? ParameterAdded;
    ...
    private void Add(object sender, EventArgs e)
    {
        ...
        {
            ParameterAdded(this, new EventHandlers.DatasourceParameterEventArgs(datasourceParameter.ParameterId));
        }
    }
