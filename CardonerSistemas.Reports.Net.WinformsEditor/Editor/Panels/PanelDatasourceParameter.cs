...
public partial class PanelDatasourceParameter : UserControl
{
    ...
    public event EventHandler<EventHandlers.DatasourceParameterEventArgs>? ParameterUpdated;
    public event EventHandler<EventHandlers.DatasourceParameterEventArgs>? ParameterDeleted;
    ...
    private void TypeChanged(object sender, EventArgs e)
    {
        ...
        // Numeric value
        labelValueNumeric.Visible = valueType is Model.Value.Types.Integer or Model.Value.Types.Decimal;
        numericUpDownValueNumeric.Visible = valueType is Model.Value.Types.Integer or Model.Value.Types.Decimal;
        if (valueType is Model.Value.Types.Integer or Model.Value.Types.Decimal)
        {
    ...
    private void ApplyChanges(object sender, EventArgs e)
    {
        ...
        {
            ParameterUpdated(this, new EventHandlers.DatasourceParameterEventArgs(_datasourceParameter.ParameterId));
        }
    }
    ...
    {
        if (_report.Datasource is null || _datasourceParameter is null || MessageBox.Show(string.Format(CultureInfo.CurrentCulture, Properties.Resources.StringDatasourceParameterDeleteConfirmation, _datasourceParameter.DisplayName), _applicationTitle, MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No)
        {
            return;
        }
        ...
        {
            ParameterDeleted(this, new EventHandlers.DatasourceParameterEventArgs(_datasourceParameter.ParameterId));
        }
    }
