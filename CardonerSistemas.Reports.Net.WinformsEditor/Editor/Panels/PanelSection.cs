...
public partial class PanelSection : UserControl
{
    ...
    public event EventHandler<EventHandlers.SectionEventArgs>? SectionUpdated;
    public event EventHandler<EventHandlers.SectionEventArgs>? SectionDeleted;
    ...
    private void ApplyChanges(object sender, EventArgs e)
    {
        ...
        {
            SectionUpdated(this, new EventHandlers.SectionEventArgs(_section.SectionId));
        }
    }
    ...
    {
        if (_section is null || MessageBox.Show(string.Format(CultureInfo.InvariantCulture, Properties.Resources.StringSectionDeleteConfirmation, _section.DisplayName), _applicationTitle, MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No)
        {
            return;
        }
        ...
        {
            SectionDeleted(this, new EventHandlers.SectionEventArgs(_section.SectionId));
        }
    }
